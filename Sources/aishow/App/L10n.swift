...
final class L10n: ObservableObject {
    ...
    nonisolated private static let table: [UILanguage: [String: String]] = [
        .en: [
            ...
            "settings.microphoneDefault": "System default (automatic)",
            "settings.microphoneCurrently": "currently: %@",
            "settings.microphoneNotConnected": "not connected",
            "settings.microphoneNote": "Pick the built-in microphone to keep AirPods on the high-quality audio profile while listening to music.",

            // MenuBarApp
            "menu.status": "Status…",
            "menu.settings": "Settings…",
            "menu.quit": "Quit",
            "menu.flame": "Flame overlay",
            ...
            "error.accessibilityMissing": "Accessibility permission is missing. It will start automatically once granted.",
        ...
        .ja: [
            ...
            "settings.microphoneDefault": "システムの自動選択",
            "settings.microphoneCurrently": "現在: %@",
            "settings.microphoneNotConnected": "未接続",
            "settings.microphoneNote": "音楽再生中に AirPods の音質を落とさないためには内蔵マイクを選んでください。",
            ...
            "error.accessibilityMissing": "Accessibility 権限がありません。許可されると自動で開始します。",
